...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/:id/quota_policy/reset", controller.ResetTokenQuotaPolicy)
		...
		dataRoute.GET("/channels", middleware.AdminAuth(), controller.GetChannelQuotaReportData)
